...
<article class="clinic-row" data-lat="<?php echo esc_attr( $lat ); ?>" data-lng="<?php echo esc_attr( $lng ); ?>" data-title="<?php echo esc_attr( get_the_title() ); ?>">
	<div class="clinic-row-inner">
		<a class="clinic-row-media" href="<?php the_permalink(); ?>">
			<?php if ( $image ) : ?>
				<img src="<?php echo esc_url( $image['url'] ); ?>" alt="<?php echo esc_attr( $image['alt'] ); ?>" loading="lazy">
			<?php else : ?>
				<div class="clinic-card-placeholder" aria-hidden="true">
					<svg width="28" height="28" viewBox="0 0 24 24" fill="none"><path d="M12 2 4 6v6c0 5 3.4 8.7 8 10 4.6-1.3 8-5 8-10V6l-8-4Z" stroke="currentColor" stroke-width="1.5"/></svg>
				</div>
			<?php endif; ?>
		</a>

		<div class="clinic-row-body">
			...
			<?php if ( $tel ) : ?>
				<p class="clinic-row-meta">
					...
					<?php echo esc_html( acdq_format_phone_display( $tel ) ); ?>
				</p>
			<?php endif; ?>
